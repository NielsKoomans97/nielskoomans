            ...
            <div class="col flex-column">
                <div class="row justify-content-center align-items-center">
                    <div class="col-4 col-md-6 col-sm-12 col-12">
                        <form method="POST" action="<?php echo e(route('login')); ?>" class="padding-2">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row pt-5 m-0 gap-3 justify-content-end align-items-center">
                                <a href="<?php echo e(route('register')); ?>" class="d-flex align-items-center gap-2">
...
<?php echo $__env->make('base.layout', ['title' => 'Inloggen'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\nielskoomans\resources\views/auth/login.blade.php ENDPATH**/ ?>